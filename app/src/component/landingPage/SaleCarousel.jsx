...
export default function SaleCarousel() {
  ...
  return (
    <div className={style.saleCarousel}>
      <div>
        <a href='/'><img src={images[imgaeChange].img} alt="img" /></a>
      </div>
      <div>
        <a href="/"><img src="https://onemg.gumlet.io/image/upload/w_480,h_200,,a_ignore,q_auto,f_auto/v1648147743/z9rugafadv1tiqitpkfi.png" alt="" /></a>
      </div>
    </div>
  )
}